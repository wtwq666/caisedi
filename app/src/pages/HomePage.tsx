...
export default function HomePage() {
  ...
  return (
    <div className="space-y-6">
      <section className="rounded-2xl border border-brand-yellow-border/35 bg-gradient-to-br from-brand-yellow via-brand-yellow-soft/95 to-brand-yellow-elevated/85 px-5 py-5 sm:px-6 sm:py-6 shadow-sm">
